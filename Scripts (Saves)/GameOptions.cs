...
{
	[Header("Music Player")]
	[SerializeField] internal MusicPlayer musicPlayer = default;

	[Header("Save version")]
	[SerializeField] internal float saveVersion = 3.2f;
	...
	[SerializeField] internal int customPB = 0;
	[SerializeField] internal bool customPBEnabled = false;
	...
	public bool GetCustomSoulsEnabled() { return customSoulsEnabled; }
	...
	private void CheckCreateDefault()
	{
		...
		{
			SaveSystem.SaveGameDefault(this);
