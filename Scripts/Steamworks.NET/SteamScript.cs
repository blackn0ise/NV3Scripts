...
public class SteamScript : MonoBehaviour
{
	...
	private void SaveHighScoreLocal(int score)
	{
		...
		//save local
		SaveSystem.SaveGame(score, gops, gops.GetSave().inputSensitivity, mvol, svol, Screen.currentResolution.width, Screen.currentResolution.height, QualitySettings.GetQualityLevel(), gops.GetSave().sfov, gops.GetSave().inputOverrideJson, gops.GetSave().postProcessingEnabled);
