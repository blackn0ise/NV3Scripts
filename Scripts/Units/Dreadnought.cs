...
public class Dreadnought : MonoBehaviour, ITargetableFocused, IShooter, IChaser, IStrafer, IHoverer, IRandomTargeter
{
	[Header("References")]
	...
	[SerializeField] private float ytarget = 55;
	...
	public ArmoredUnit GetUnit() { return unit; }
	...
	void Start()
	{
		...
		{
			wp.SetHurtClip(sl.GetDreadnoughtHurt());
			wp.SetDeadClip(sl.GetDreadnoughtWPDead());
		}
	...
	public void ChooseStrafeDirectionAndDuration()
	{
		...
		Vector3 offset = new Vector3(UnityEngine.Random.Range(-offsetamount, offsetamount), UnityEngine.Random.Range(-offsetamount, offsetamount), UnityEngine.Random.Range(-offsetamount, offsetamount));
		Vector3 newDirection = backward + offset;
		newDirection = newDirection.normalized;
		strafeDirection = newDirection;
		confirmedStrafeDuration = UnityEngine.Random.Range(baseStrafeDuration - strafeDurationOffset, baseStrafeDuration + strafeDurationOffset);
	}
	...
	{
		float random = UnityEngine.Random.Range(0, possibletotal);
